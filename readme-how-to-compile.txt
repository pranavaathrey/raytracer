...
|
cl source-files/main.cpp source-files/canvasHandler.cpp source-files/rayTracer.cpp source-files/sceneDefinition.cpp source-files/vectorMath.cpp source-files/postProcessing.cpp source-files/BMPwriter.cpp /std:c++17 /EHsc /I"%SFML_DIR%\include" /link /LIBPATH:"%SFML_DIR%\lib" sfml-graphics.lib sfml-window.lib sfml-system.lib
